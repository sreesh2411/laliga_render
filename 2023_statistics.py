...
# Load the data from your JSON file
# Load the data from your JSON file
json_2023 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2023.json'
response = requests.get(json_2023)
data = response.json()
...
# Load the data from your JSON file
json_2023 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/fixtures_2023.json'
response = requests.get(json_2023)
data = response.json()
...
dfs1 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2023standings(12).csv') 
dfs2 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2023points(12).csv')
