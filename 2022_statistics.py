...
json_2019 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2019.json'
response = requests.get(json_2019)
data = response.json()
...
# Load the data from your JSON file
json_2020 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2020.json'
response = requests.get(json_2020)
data = response.json()
import pandas as pd
...
# Load the data from your JSON file
json_2021 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2021.json'
response = requests.get(json_2021)
data = response.json()
...
# Load the data from your JSON file
json_2022 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2022.json'
response = requests.get(json_2022)
data = response.json()
...
# Load the data from your JSON file
json_2022 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/fixtures_2022.json'
response = requests.get(json_2022)
data = response.json()
...
dfs1 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2022standings(38).csv') 
dfs2 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2022points(38).csv')
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8048, use_reloader=False)
